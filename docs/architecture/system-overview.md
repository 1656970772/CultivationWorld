...
| 时间域 | 粒度 | 职责 |
|---|---|---|
| Hot 实时域 | 帧或短步长 | 玩家附近移动、即时反应、战斗、相遇检测和剧情对话。 |
| Warm 日域 | 1 天 | 玩家附近外圈、玩家标记对象、近期可接触 NPC，复用当前 Tick 与 Job/Toil。 |
| Cold 月压缩域 | 30 天或配置化月长 | 远处 NPC 与远方系统一次性结算关系、背包、修为、境界、地点轨迹、任务、死亡、日志和剧情包状态。 |

详细架构见 `docs/architecture/world-simulation/README.md` 和 ADR-058。
