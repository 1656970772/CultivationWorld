...
- 当前实现事实：`E:\AI_Projects\storygraph\src\paths.ts`、`E:\AI_Projects\storygraph\src\indexing\indexer.ts`、`E:\AI_Projects\storygraph\src\cli.ts` 仍按传入的 `projectRoot` 打开 `.storygraph/storygraph.db`，需要按本规格修订。
